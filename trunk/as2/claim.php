...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
	    <title>Online claim form, The Accident Specialists, North West London</title>
	...
	<body id="pgClaimForm" class="claim">
		<div id="shortcuts">
			...
			<div id="content">
				...
				<div id="breadcrumb">
					<div id="breadcrumbInner">
						...
						<ul>
							...
							<li class="on">Online claim form</li>
						</ul>
					</div>
				</div
				...
				<div id="sections">
					...
					<div id="secondary">
						...
						<ul>
							<li>About the claims process</li>
							<li>Lorem ipsum</li>
