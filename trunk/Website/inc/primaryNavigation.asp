<div id="primaryNavigation">
	<ul>
		...
		<li id="pnServices"><a href="<%=Adoro.URL%>/services.asp" <%if(Adoro.pageName === "services"){%>class="selected"<%}%>>Services</a></li>
		<li id="pnPortfolio"><a href="<%=Adoro.URL%>/portfolio.asp" <%if(Adoro.pageName === "portfolio"){%>class="selected"<%}%>>Portfolio</a></li>
		<li id="pnFaq"><a href="<%=Adoro.URL%>/faq.asp" <%if(Adoro.pageName === "faq"){%>class="selected"<%}%>>FAQ</a></li>
		<li id="pnProjects"><a href="<%=Adoro.URL%>/projects" <%if(Adoro.siteSection === "projects"){%>class="selected"<%}%>>Projects</a></li>
