...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<script type="text/javascript" src="<%=Adoro.URL%>/js/Adoro/Adoro.Dialogue.js"></script>
		<script type="text/javascript" src="<%=Adoro.URL%>/js/Site/Projects/Site.Projects.Dialogue.js"></script>
		<link rel="stylesheet" href="<%=Adoro.URL%>/css/dialogue.css" type="text/css" />
