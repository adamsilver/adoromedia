...
J2.Core = new (function() {
	...
	*/
	this.EventHandler = function() {
		...
		*/
		this.addHandler = function(fn, context, sortIndex) {
...
J2.Element = new (function() {
	...
	*/
	this.getStyle = this.getOpacity = function(property) {
		property = property.hyphenatedToCamelCase();
		//detect special cases for properties
		if (property === "backgroundColor" && !J2.isIE)
		...
		if (property === "float")
			property = (J2.isIE) ? "styleFloat" : "cssFloat";
		if (J2.isIE && ["width", "height"].contains(property)) {
	...
	*/
	this.addEvent = function(type, fn, sortIndex) {
		...
		this.events[type].addHandler(fn, this, sortIndex);
		return fn;
	};
	/**
	...
	*/
	this.removeAllEvents = function(type, purgeChildNodes) {
		...
		if (!events) return;
		if (events instanceof J2.Core.EventHandler) {
	...
	*/
	...
	/**
	* Fire an event programatically.  Event will not bubble.
	* @function
	* @name fireEvent
	* @memberOf J2.Element.Tools
...
(function() {
	if (/function|object/.test(typeof HTMLElement))
		...
		window.addDOMReadyEvent( function() { J2.Core.bindElementTools( document.getElementsByTagName("body")[0] ) }, -99999 );
